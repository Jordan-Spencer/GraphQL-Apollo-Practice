# React Table Countries practice evaluation
...
- The starting point code in this repo queries a list of all countries and puts them on the screen as JSON.
...
- Fill in the endpoint you received in the `env.js` file.

- You should have also received screenshots containing the design you have to implement.
...
- We also aren't expecting any sophisticated caching solutions or anything of the sort. The very basic features of Apollo are all you need.
